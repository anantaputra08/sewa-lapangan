    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8">
                    <form method="POST" action="{{ route('session-hours.update', $sessionHour) }}">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="start_time" name="start_time" type="time" class="mt-1 block w-full"
                                    :value="old(
                                        'start_time',
                                        \Carbon\Carbon::parse($sessionHour->start_time)->format('H:i'),
                                    )" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="end_time" name="end_time" type="time" class="mt-1 block w-full"
                                    :value="old(
                                        'end_time',
                                        \Carbon\Carbon::parse($sessionHour->end_time)->format('H:i'),
                                    )" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="description" name="description" type="text"
                                    class="mt-1 block w-full" :value="old('description', $sessionHour->description)" />
